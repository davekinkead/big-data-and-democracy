...
Broadcast mass media is ephemeral to its audience unless it is recorded. The specialised equipment needed to record radio and television broadcasts were first limited to broadcasters, meaning that the audience had to rely on their memory of the broadcast or on reports of broadcasts written by others. The introduction of consumer audio recording and video recording equipment allowed audience to make their own recordings of broadcast messages.

Mass media also made events in other countries, other continents, and even in space visible instanteously. The speed with which images, films, and recordings of events could be recorded and broadcast across the world gave individuals more vivid impressions of remote events than were possible through written accounts on their own.
...
## The Promise of Computer-Mediated Communication (CMC)

The development of the personal computer created the new possibility of Computer-Mediated Communication (CMC) between individuals, regardless of their geographical proximity. 

The Internet was also promoted as an egalitarian tool for political communication. It offered the possibility of returning to the bidirectional (many-to-many) political communication of earlier times, in contrast to the unidirectional (one-to-many) communication offered by mass media [@rheingold_virtual_1994, p. 244]. 
...
The general characteristics of these forms of public political discussion are listed in the following table.

Medium                               Direction         Reach                  Permanence             Targeting
Face-to-face                         Bidirectional     Physical proximity     Ephermeal              Narrowcast              
Printing                             Bidirectional     National/International Static                 Broadcast               
Radio/Television                     Unidirectional    Global                 Ephermeal/Static       Broadcast               
Computer-Medicated Communication     Bidirectional     Global                 Static                 Broadcast               
